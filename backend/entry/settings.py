...
# OpenWebUI
OPENWEBUI_URL = getenv_or_raise("OPENWEBUI_URL")
OPENWEBUI_KEY = getenv_or_raise("OPENWEBUI_KEY")

# Usage
DEFAULT_TOKEN_PRICE = int(os.getenv("DEFAULT_TOKEN_PRICE", "60"))
MODEL_PREFIX_TO_REMOVE = os.getenv("MODEL_PREFIX_TO_REMOVE", "")
DEFAULT_MODEL_FOR_TOKEN = os.getenv("DEFAULT_MODEL_FOR_TOKEN", "gpt-4o")
IGNORE_MODEL_ENCODING = strtobool(os.getenv("IGNORE_MODEL_ENCODING", "False"))
